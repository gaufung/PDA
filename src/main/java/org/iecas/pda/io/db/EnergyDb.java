 ...
 */
class EnergyDb implements Serializable {
    public int id;
    ...
    public EnergyDb(String province, String year,
    ...
    public double getCokeGas() {
        return cokeGas;
    }

    public double getOtherGas() {
        return otherGas;
    }
    ...
    public double getLiquefied() {
        return liquefied;
    }

    public double getRefineGas() {
        return refineGas;
    }
    ...
    public void setRefineCoal(double refineCoal) {
        this.refineCoal = refineCoal;
    }
    ...
    public void setBriquette(double briquette) {
        this.briquette = briquette;
    }
    ...
    public void setCokeGas(double cokeGas) {
        this.cokeGas = cokeGas;
    }

    public void setOtherGas(double otherGas) {
        this.otherGas = otherGas;
    }
    ...
    public void setLiquefied(double liquefied) {
        this.liquefied = liquefied;
    }

    public void setRefineGas(double refineGas) {
        this.refineGas = refineGas;
    }
